...
**3. Converting the gaz columns to the appropriate type, and any placeholders for unknown data to NA**
...
**5. Write the gaz tibble to a CSV files (using "|" as a delimiter)**
