...
```{r 4}
write_delim(gaz, "/USERS/wagnerquiros/Desktop/UCSB/Courses/Spring 2017/Informatics/newprojects/Assignments_ESM262/gazzca.csv", delim = "|")
```
...
CAGAZ <- filter!(PRIM_LAT_DEC == 'NA' | PRIM_LONG_DEC == 'NA') 
View(CAGAZ)
```
